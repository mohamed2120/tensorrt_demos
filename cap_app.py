...
# def activate_start_output(stopper_01):
#     print("im here thrid")
...
def loop_and_detect(cam, trt_yolo, conf_th,save_labels,vis):
    ...
    while True:
        ...
        if Normal_Mode:
            if current_40 > 0.5 and stopper_count  == 6:
                stopper_01.value = True
                time.sleep(2)
                stopper_01.value = False
        if Sortout_Mode:
            ...
            stopper_01.value = True
            do_detection = False
            print("push_out_count   :" ,stopper_count)
            print("im here stortout")
            # time.sleep(1.4)
            ...
            while Sortout_Mode:
                do_detection = False
                print("Current_41_before  : {:7.4f}  mA".format(current_41))
                if (current_41 > 1.7):
                    print("im here stopper_on")
                    print("Current_41_after  : {:7.4f}  mA".format(current_41))
                    pucher_01.value = True # red led on
                    print("================================================s")
                    time.sleep(2)
                
                    pucher_01.value = False # red led off
                    time.sleep(0.2)
                    stopper_01.value = False # yellow led off
                    Sortout_Mode = False
